...
class Loader
{
	...
	public function __construct()
	{
        ...
        add_filter( 'nav_menu_css_class', array( 'Apiki\Theme\Utils', 'define_class_to_empty_menu_item' ), 11, 3 );
	...
	{
		Utils::avoid_gform_confirmation_anchor();
		Utils::define_content_width( 768 ); // Ver no css o tamanho do content
	}

	public function install()
	{
		add_action( 'admin_init', array( 'Apiki\Theme\Utils', 'create_template_pages' ) );
	}
	...
	{
		load_theme_textdomain( App::TEXTDOMAIN, Utils::get_template_directory() . '/languages' );
	}
	...
	private function _handle_instance( $class )
	{
		new $class( true );
	}
}